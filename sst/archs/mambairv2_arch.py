'''
An official Pytorch impl of `MambaIRv2: Attentive State Space Restoration`.

Arxiv: 'https://arxiv.org/abs/2411.152697'
...
if __name__ == '__main__':
    ...
    test_direct_metrics(model, shape, use_float16=False, n_repeat=10)
